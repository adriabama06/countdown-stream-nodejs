...
exports.timeArray = exports.createFile = void 0;
...
var createFile = /** @class */ (function (_super) {
    ...
    function createFile(time, file, startmessage, endmessage) {
        var _this = _super.call(this) || this;
        _this.data = [];
        _this.main(time, file, startmessage, endmessage);
        return _this;
    }
    ;
    createFile.prototype.main = function (time, file, startmessage, endmessage) {
        if (startmessage === void 0) { startmessage = false; }
        if (endmessage === void 0) { endmessage = false; }
        return __awaiter(this, void 0, void 0, function () {
            var i, i, _i, _a, t;
...
;
function timeArray(time, startmessage, endmessage) {
    var data = [];
    if (time >= 3600) {
